...
public class ColorUtils {
    ...
    public static String replaceColorAndFormat(char altColorCode, String message) {
        ...
        return ChatColor.translateAlternateColorCodes(altColorCode, message);
    }

    public static boolean isValidHexCode(String hexCodeString) {
        return hexCodeString.replace("#", "").toLowerCase()
                .matches("(\\d|[a-f])(\\d|[a-f])(\\d|[a-f])(\\d|[a-f])(\\d|[a-f])(\\d|[a-f])");
    }
